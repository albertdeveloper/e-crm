    ...
    <app-layout>
        <template #header>
            ...
            <div class="float-right">
                ...
                <a @click.prevent="submitForm" v-if="$page.user.allowed_gates.includes('leads_process')"
                   class="cursor-pointer btn-primary mb-5 transition duration-300 ease-in-out focus:outline-none focus:shadow-outline bg-teal-700 hover:bg-teal-900 text-white font-normal py-2 px-4 mr-1 rounded">
                    Save and New
                </a>
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        <div class="absolute inset-y-0 left-0 flex items-center">
                                            <select id="salutation" v-model="form.salutation" name="salutation"
                                                    class="focus:ring-indigo-500 focus:border-indigo-500 h-full py-0 pl-1 pr-3 border-transparent bg-transparent  rounded-md">
                                                <option></option>
                                                <option>Mr.</option>
                                                <option>Mrs.</option>
                                                <option>Ms.</option>
    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                title: this.lead_data.title,
                email: this.lead_data.email,
                phone: this.lead_data.phone,
                fax: this.lead_data.fax,
                mobile: this.lead_data.mobile,
                website: this.lead_data.website,
                lead_source: this.lead_data.lead_source_id,
                lead_status: this.lead_data.lead_status_id,
                industry: this.lead_data.industry,
                no_employee: this.lead_data.no_employee,
                street: this.lead_data.street,
                city: this.lead_data.city,
                state: this.lead_data.state,
                zip_code: this.lead_data.zip_code,
                country: this.lead_data.country,
            })
        }
    },
    methods: {
