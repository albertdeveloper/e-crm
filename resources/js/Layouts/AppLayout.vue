<template>
    <div class="min-h-screen bg-gray-100">
        <Toast :toast="$page.toast" :popstate="$page.popstate" ></Toast>
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <jet-nav-link :href="route('admin.leads.index')"
                                          :active="route().current('admin.leads.index')"
                                          v-if="$page.allowed_gates.includes('leads_access')">
                                Leads
                            </jet-nav-link>

                            <jet-nav-link :href="route('admin.contacts.index')"
                                          :active="route().current('admin.contacts.index')"
                                          v-if="$page.allowed_gates.includes('contacts_access')">
                                Contacts
                            </jet-nav-link>

                            <jet-nav-link :href="route('admin.accounts.index')"
                                          :active="route().current('admin.accounts.index')"
                                          v-if="$page.allowed_gates.includes('accounts_access')">
                                Accounts
                            </jet-nav-link>
                            ...
                            <jet-dropdown align="right" width="48">
                                ...
                                <template #content>
                                    ...
                                    <template v-if="$page.jetstream.hasTeamFeatures">
                                        ...
                                        <div v-if="$page.allowed_gates.includes('user_management_access')">

                                        <div class="block px-4 py-2 text-xs text-gray-400">
                                            Manage User
                                        </div>

                                        <jet-dropdown-link :href="route('admin.permissions.index')">
                                            Permissions
                                        </jet-dropdown-link>
